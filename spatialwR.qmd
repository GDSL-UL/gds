...
# Base layers with per-layer legends
rest_map <- tm_shape(df) +
  tm_polygons(
    fill = "mistyrose3", col = "black", lwd = 0.5,
    fill.legend = tm_legend(labels = "Rest of LSOAs", title = "")
  )

neighbors_map <- tm_shape(obs1_nb_q) +
  tm_polygons(
    fill = "steelblue4", col = "black", lwd = 0.5,
    fill.legend = tm_legend(labels = "Distance neighbourhood", title = "")
  )

obs1_map <- tm_shape(obs1) +
  tm_polygons(
    fill = "red2", col = "black", lwd = 0.5,
    fill.legend = tm_legend(labels = "Observation 1", title = "")
  )
...
final_map_q <- rest_map + neighbors_map + obs1_map +
  ...
  tm_layout(
    ...
    inner.margins = c(0.01, 0.1, 0.01, 0.05),
...
rest_map <- tm_shape(df) +
  tm_polygons(
    fill = "mistyrose3", col = "black", lwd = 0.5,
    fill.legend = tm_legend(labels = "Rest of LSOAs", title = "Rest of LSOAs")
  )

neighbors_map <- tm_shape(obs1_nb_d) +
  tm_polygons(
    fill = "steelblue4", col = "black", lwd = 0.5,
    fill.legend = tm_legend(labels = "Distance neighbourhood", title = "Distance neighbourhood")
  )

obs1_map <- tm_shape(obs1) +
  tm_polygons(
    fill = "red2", col = "black", lwd = 0.5,
    fill.legend = tm_legend(labels = "Observation 1", title = "Observation 1")
  )
...
w_area_map <- tm_shape(df) +
  tm_polygons(
    ...
    fill.scale = tm_scale(
      ...
      style = "quantile",
      palette = "brewer.yl_gn",
      legend = tm_legend(title = "Lagged area")),
    col = "black",
    lwd = 0.5
  ) +
  tm_compass(position = c("right", "top")) + 
