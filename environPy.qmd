...
The way you name your folders and files really matters—using clear, consistent names helps you stay organized and avoid easy mistakes.

:::


1.  Download the `envs363-563.yml` from GitHub by cliciking `Download raw file`, top right [at this page](https://github.com/pietrostefani/gds/blob/main/envs363-563.yml)
...
3.  In the **Anaconda Terminal** write: `conda env create -n envs363_563 --file M:\``envs363_563``\envs363-563.yml` and press `Enter`; if the file is located elsewhere you'll need to use the corresponding file path.
