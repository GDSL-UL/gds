...
-   Full Assignment details [here](https://theuniversityofliverpool-my.sharepoint.com/:b:/g/personal/pietrost_liverpool_ac_uk/ETf-H6RlcPNMoRMmeCCmqCEBQ_rPFZFGzfiDjVuFM66Vjw?e=WLx2b3)

You will submit an `.html` file obtained by rendering your `.qmd` in `R` or `.ipynb` Jupyter Notebook in `Python`.

-   If you are doing the assignment in `R`: You can start from this [**.qmd file**](https://theuniversityofliverpool-my.sharepoint.com/:u:/g/personal/pietrost_liverpool_ac_uk/ESgyxiH1-cRMuIBgk7H9qsUB-a2DRqmKDYpOC6-1du0xww?e=XRpSCB) to render the `html`. Other file formats will not be accepted.

-   If you are doing the assignment in `Python`: To do so, in your `.ipynb` file, follow these steps: `File –> Save and Export as.. –> HTML`. Prior to this step, the notebook needs to be rendered (i.e. all the cells should be executed). Other file formats will not be accepted. You can start from this [**.ipynb**](https://theuniversityofliverpool-my.sharepoint.com/:u:/g/personal/pietrost_liverpool_ac_uk/EZ_ygsv_puJDlw36FytiGvsBamRawQRV6QFMNgUkzUglvg?e=HDhqWV)
...
-   Full Assignment details [here](https://theuniversityofliverpool-my.sharepoint.com/:b:/g/personal/pietrost_liverpool_ac_uk/EXWCcOCQnulAjHPc3GAOsGIBOybfr5-DcNHyp0vCwI6UKA?e=4uOFTi)

- [Some data about race in csv format if you are not using API](https://github.com/GDSL-UL/gds/blob/main/data/ACS_austin_2018_2022_vars.csv)

Important information about data access through the US Census API:

-   If you are doing the assignment in `R`: You can start from this [**ENVS2526-363-563.2.qmd file**](https://theuniversityofliverpool-my.sharepoint.com/:u:/g/personal/pietrost_liverpool_ac_uk/EVV0BaXbyHxEj7sKFnDJWPoBFfUEXJbIbzfs3UPcZc8ZFA?e=OvwNYZ) to render the `html`. Other file formats will not be accepted.

-   In Python, you can start from this [**ENVS2526-363-563.2.ipynb**](https://theuniversityofliverpool-my.sharepoint.com/:u:/g/personal/pietrost_liverpool_ac_uk/EUf0AUpaY4lGvRoBjfcNPxEBQOSKAR8TnOSUylyM-cH7_A?e=UeRi94)

**Overview**

Here’s the premise. You will take the role of a real-world geographic data scientist tasked to explore datasets on Austin (Texas) and find useful insights for a variety of city decision-makers. It does not matter if you have never been to the Austin (Texas). In fact, this will help you focus on what you can learn about the city through the data, without the influence of prior knowledge. Furthermore, the assessment will not be marked based on how much you know about Austin (Texas) but instead about how much you can show you have learned through analysing data. You will need contextualise your project by highlighting the opportunities and limitations of ‘old’ and ‘new’ forms of spatial data and reference relevant literature.
