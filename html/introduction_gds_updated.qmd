...
## Generative AI {background-color="#fdf3e3"}

You **may** use Generative AI tools (ChatGPT, Copilot, Claude...) for support.

::: fragment
But **inappropriate use is prohibited** — if you can't explain or justify it yourself, it's an **Academic Integrity concern**.
:::

::: fragment
A **short declaration** is required with every submission: which tool, for which part (narrative/code), and how.
:::

## Generative AI — what to declare {background-color="#eafaf1"}

::: incremental
- ✍️ **Narrative**: your own words — AI proof-reading that changes wording/structure must be declared
