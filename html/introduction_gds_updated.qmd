...
::: fragment
Generative AI tools (ChatGPT, Copilot, Claude...) are broadly **allowed and encouraged** for **specific stages** or **tasks** in both assignments.
:::
...
## Critical thinking: questions to ask of any map {background-color="#ffd54f"}
