...
# Custom palette: dark blue to light yellow
blue_yellow <- c("#08306B", "#FFFFB2")
...
map1992 <- tm_shape(df) +
  tm_polygons(
    fill = "mean.NL1992",
    col = "grey", lwd = 0.5,
    fill.scale = tm_scale(values = blue_yellow),
    fill.legend = tm_legend(title = "Mean 1992")
  )
...
map2013 <- tm_shape(df) +
  tm_polygons(
    ...
    col = "grey", lwd = 0.5,
    fill.scale = tm_scale(values = blue_yellow),
    fill.legend = tm_legend(title = "Mean 2013")
  )
...
tm_shape(df) +
  tm_polygons(
    fill = c("mean.NL1992", "mean.NL2013"),
    col = "grey", lwd = 0.5,   # white polygon borders
    fill.scale = tm_scale(
      values = blue_yellow,
      breaks = c(0, 0.05, 0.1, 2, 63),
      style = "fixed"
    ),
    fill.legend = tm_legend(title = "Average nightlights")
  ) +
