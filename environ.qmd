...
-   If you want to follow the course in `R`, you can find instructions to set up your environment [here](https://gdsl-ul.github.io/gds/environR.html).

-   If you want to follow the course in `Python`, you can find instructions to set up your environment [here](https://gdsl-ul.github.io/gds/environPy.html).
